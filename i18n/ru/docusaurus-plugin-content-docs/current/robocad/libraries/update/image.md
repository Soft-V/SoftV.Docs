...
В представленных таблицах вы можете выбрать нужную вам версию образа для устройства.   

:::note
На каждой версии образа указаны версии библиотек и поддерживаемые языки программирования.
:::
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th width="40%">Доступные модули и их версии</th>
                    <th width="20%">Ссылка на скачивание</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td><Link to="https://cloud.mail.ru/public/7oKC/4tNxUuZb6"><b>Скачать</b></Link></td>
                </tr>
            </tbody>
        </table>
    </TabItem>
...
После скачивания образа — установите его на SD карту устройства удобным для вас образом.
