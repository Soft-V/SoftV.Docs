...
Узнайте больше про симулятор мобильных роботов!
...
При обнаружении проблем или ошибок в любом из продуктов Soft V, создавайте Issue в *GitHub*, если это возможно.

:::info
Ссылка на *GitHub* Soft V [перейти](https://github.com/Soft-V).
:::

Ищите нас в *Telegram*.

:::info
Присоединяйтесь к [сообществу](community.md).
:::
