...
Контроллер VMX Robotics Controller интегрирует встроенный 9-осевой инерциальный измерительный модуль (IMU) на основе технологии navX, который обеспечивает широкие возможности измерения движения и отслеживания ориентации для робототехнических приложений. Однако на данный момент доступен только yaw.

Приведённый ниже фрагмент кода отправляет значения рысканья (yaw) в shufflecad.
...
:::note
Значение угла рысканья находится в диапазоне от -180 до 180 градусов.
:::