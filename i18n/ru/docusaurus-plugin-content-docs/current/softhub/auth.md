...
Далее необходимо нажать на **Настройки**.
<div style={{textAlign: 'left'}}>
<img src="/docshome/img/softhub/auth2.png"/>
</div>
И нажать на кнопку **Зарегистрироваться**.
<div style={{textAlign: 'left'}}>
...
Если вам необходимо войти в существующий аккаунт, нажмите на кнопку **Войти**.
<div style={{textAlign: 'left'}}>
<img src="/docshome/img/softhub/auth8.png"/>
</div>
Здесь нужно ввести данные зарегистрированного аккаунта:
- Адрес электронной почты;
- Пароль.
<div style={{textAlign: 'left'}}>
