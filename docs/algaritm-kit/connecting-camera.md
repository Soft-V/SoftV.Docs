...
The kit includes a RealSense D430 depth camera — a stereo vision module with active infrared technology for 3D perception. It features two global shutter imagers and delivers depth video at up to 90 fps and 1280×720 resolution.

<img src="/docshome/img/algaritm-kit/other/d430-camera.png"/>

Connect the camera using the standard Type‑C cable included in the kit — plug the Type‑C end into the camera and the Type‑A end into the controller.
