...
The code snippet gets yaw, roll and pitch values and sends them to shufflecad. This provides a quick and easy way to verify that orientation sensor is functioning properly and that connection have been made correctly.
