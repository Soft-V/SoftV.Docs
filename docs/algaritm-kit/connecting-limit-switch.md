...
The code snippet below gets boolean value from the limit switch connected to the Llim port on M3 motor and sends it to shufflecad . This provides a quick and easy way to verify that each motor is functioning properly and that all connections have been made correctly.
