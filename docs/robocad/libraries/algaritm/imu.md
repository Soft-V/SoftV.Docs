...
The IMU is used to determine the robot's rotation angles across three axes.
...
<Tabs
    ...
    <TabItem value="python">  
        ```python
        # rotate until the robot reaches an angle of 90 degrees
...
:::note
Angle values are in the range from `0` to `360` degrees.
:::
